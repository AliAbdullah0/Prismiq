import { Field, Model, Schema } from "./types";
...
class SchemaBuilder {
    ...
    addField(modelName: string, fieldName: string, type: "Int" | "String" | "Boolean" | "Date" | "float" | "Json", defaultValue?: "cuid()" | "uid()" | "now()",isUnique?: boolean): void {
        ...
        model.fields.push({ name: fieldName, type: prismaType, default: defaultValue,isUnique:isUnique ?? false });
    }
...
export const addField = (modelName: string, fieldName: string, type: "Int" | "String" | "Boolean" | "Date" | "float" | "Json", defaultValue?: "cuid()" | "uid()" | "now()") =>
    builder.addField(modelName, fieldName, type, defaultValue);
